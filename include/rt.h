...
/*   Updated: 2020/11/21 20:44:38 by sdiego           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_matrix					shearing(double x_y, double x_z, double y_x,
...
t_material *m);
t_vec						world_point_to_pattern_point(t_pattern p,
t_matrix transform, t_vec world_point);
...
** texuture mapping
*/
t_pattern					uv_checkers(int width, int height, t_color a,
t_color b);
